...
def main():
    ...
    # test_size parameter determines the proportion of the data that will be allocated to the testing set. 
    # 20% of the data is allocated to the testing set, while the remaining 80% is used for training.

    # random_state parameter is used to set a seed value for the random number generator.
